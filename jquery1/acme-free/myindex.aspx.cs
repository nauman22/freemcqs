...
namespace jquery1.acme_free
{
    ...
    public partial class myindex : System.Web.UI.Page
    {
     ...
     //   public string userrole { get; set; }
       ...
       [System.Web.Services.WebMethod(EnableSession = false)]
        public static string InsertSubject(string subjectName, string Emyadminid, int catid)
        {
            string constr = ConfigurationManager.ConnectionStrings["vuhomework"].ConnectionString;
      ...
      [System.Web.Services.WebMethod(EnableSession = false)]
       public static string Update_SubjectName(string SubjectName, int SubjectId, string Emyadminid, int catid)
        {
            string constr = ConfigurationManager.ConnectionStrings["vuhomework"].ConnectionString;
            string msg = string.Empty;
            using (SqlConnection con = new SqlConnection(constr))
      ...
      [System.Web.Services.WebMethod(EnableSession = false)]
       ...
       [System.Web.Services.WebMethod(EnableSession = false)]
       public static string InsertTestName_Multiple(string TestName, string Emyadminid, string SubjectId, string Alltestids)
       {
           string constr = ConfigurationManager.ConnectionStrings["vuhomework"].ConnectionString;
           string msg = string.Empty;
           using (SqlConnection con = new SqlConnection(constr))
       ...
       // [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        ...
        [System.Web.Services.WebMethod(EnableSession = false)]
        public static List<ddlSubject> LoadddlSubject(string dadminid)
        {
            return LoadddlSubject1(dadminid);
        }
        [System.Web.Services.WebMethod(EnableSession = false)]
       // [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static List<ddlSubject> LoadddlSubject1(string dadminid)                      //this method is a static type and list<property> is return.  
        {
            // HiddenField AdminId = ""; //(Int32)HttpContext.Current.Session["AdminId"];
            // // Int32 AdminId = 124;
            string id = dadminid;
      ...
      // [System.Web.Services.WebMethod(EnableSession = false)]
        ...
        public static int Edit_Mcqs(string SubjectId, string TestId, string QuestionId, string QuestionText, string points, string txtOption1
                                                ...
                                                , string chkOption3, string chkOption4, string chkOption5
                                                , string chkOption6, string chkOption7, string chkOption8
                                                , string ReferenceText, string ExplanationText, string Emyadminid)
        {
        ...
        public static string tblSubUser_Insert(int UserRoleId, string UserName, string UserEmail, string UserPassword,
                                               ...
                                               , bool UserResultCardDesignCustomize, bool EmailResultToUser, string TermsAndConditionsForUsers
                                                ...
                                                , bool EmailTestResultToAdmin, bool AllResult, string UserTestStartDateTime, string UserTestEndDateTime, string Emyadminid
                                                )
        {
...
" * from tblAdminManager a ", con)) //GetCountryRecords is a Stored Procedure.  
                                    ...
                                    if (ds.Tables[0].Rows.Count > 0)
                                    {
                                        foreach (DataRow dr in ds.Tables[0].Rows)
                                        {
                                            Dashboard_UsersMcqs.Add(new UserAddedMcqs()
                                            {
                                                ...
                                                //CatName = (DBNull.Value.Equals(dr["AdminName"]) ? "No Name" : ""),
        ...
        public static List<UsersDetail> UsersDetail(string Emyadminid, string userid)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                if (userid != "") 
                {
                    sql = "select * from View_ShowUserDetail Where UserDeletebit = 0 and AdminId = '" + AdminId + "' and subUserId = '" + userid + "'";
                ...
                {
                    sql = "select * from View_ShowUserDetail Where UserDeletebit = 0 and AdminId = '" + AdminId + "'";
                }
               // 
        ...
        [System.Web.Services.WebMethod(EnableSession = false)]
        public static List<ShowMcqsQuestionOnly> LoadMcqsQuestions_(int SubId, int TestId, string Emyadminid)
        {
            return LoadMcqsQuestion(SubId, TestId ,Emyadminid);
        }

        //this method is a static type and list<property> is return.
        public static List<ShowMcqsQuestionOnly> LoadMcqsQuestion(int SubjectId, int Testid ,string Emyadminid)
        {
            //// Int32 AdminId = (Int32)HttpContext.Current.Session["AdminId"];
            //// Int32 AdminId = 124;
            Int32 AdminId = Convert.ToInt32(Decrypt(Emyadminid));
        ...
        [System.Web.Services.WebMethod]
        public static List<ddlTest> LoadddlTestForSpecificSub(int SubId, string Emyadminid)
        {
            return LoadddlTestForSpecificSubj(SubId, Emyadminid);
        }
        //this method is a static type and list<property> is return. 
        [System.Web.Services.WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static List<ddlTest> LoadddlTestForSpecificSubj(int subid, string Emyadminid)
        {
            // // Int32 AdminId = (Int32)HttpContext.Current.Session["AdminId"];
            // // Int32 AdminId = 124;
            Int32 AdminId = Convert.ToInt32(Decrypt(Emyadminid));
