        ...
        <div class="navbar navbar-default navbar-static-top container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="myindex.aspx">Home <i class="fa fa-home"></i></a>
        ...
        <div class="row mar-b-50">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select id="ddlSubject" name="ddlSubject" class="" runat="server"></select>
                            </div>
                            ...
                            <div class="col-md-3">
                              ...
                              <label style="width:100%;">  <input type="checkbox" id="chkreloadpage" checked="checked" value="1" /> Reload on click on Save button. </label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="divShowShortQuestionAll">
                ...
                <div id="divTestSettings">
                    ...
                    <div id="divMergeTest">
                        <input type="text" id="MergeTestName" class="input-lg" /> 
                ...
                <div id="divAddUser">
                    <div class="form-inline">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <input type="password" id="txtUserPassword" class="form-control" placeholder="User Password" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
...
<label>User Name:</label>
                        ...
                        <div class="col-sm-3">
<input type="text" id="txtEditUserName" />
                        </div>
                              <div class="col-sm-1">
<label>User Email:</label>
                    </div>
                        <div class="col-sm-3">
<input type="text" id="txtEditUserEmail" />
                        </div>
                              <div class="col-sm-1">
<label>User Password:</label>
                    </div>
                        <div class="col-sm-3">
<input type="text" id="txtEditUserpwd" />
                        </div>
...
<input type="text" id="txtDeleteUserpwd" readonly="readonly" style="background-color: red;    color: white;"
 ...
 <input type="button" id="btnDeleteUser" class="btn-danger" value="Delete User" />
            ...
            <div id="divReportUser">
             ...
             <div id="loading">
  <p><img src="img/loading.gif" /> Please Wait</p>
</div>
             <%--   <div id="divUser">
